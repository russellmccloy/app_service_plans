...
New-AzureRmAppServicePlan -Name $AppServicePlanName -Location "Australia Southeast" -ResourceGroupName $ResourceGroupName -AseName $AppServiceEnvironmentName -AseResourceGroupName $ResourceGroupName -Tier Premium -WorkerSize $WorkerSize -NumberofWorkers 1
<#
